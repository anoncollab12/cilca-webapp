...
import { updateTitleClass } from "./actions";
...
export const ModuleTitle = ({ initialData, moduleId }: ModuleTitle) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await updateTitleClass(moduleId, values.title);
      toast.success("Titulo de modulo actualizado");
      toggleEdit();
      router.refresh();
