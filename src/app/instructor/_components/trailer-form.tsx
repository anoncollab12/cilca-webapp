...
import { updateTrailerCourse } from "./actions";
...
export const TrailerForm = ({ initialData, courseId }: TitleFormProps) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await updateTrailerCourse(parseInt(courseId), values.title);
