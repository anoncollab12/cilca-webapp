...
export default async function Curso({
  ...
  const videoId = curso.urlTrailer.slice(-11);
  return (
          ...
          <div className="mt-6 sm:mt-8 lg:mt-0">
            ...
            <div className="mt-6 sm:mt-8 sm:flex sm:items-center sm:gap-4">
              ...
              <a
                href="#"
                title=""
                className="bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 mt-4 flex items-center justify-center rounded-lg px-5 py-2.5 text-sm font-medium focus:outline-none focus:ring-4 sm:mt-0"
                role="button"
              >
                <svg
                  className="-ms-2 me-2 h-5 w-5"
